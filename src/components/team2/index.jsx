...
const SkeletonCourseCard = () => (
  <div className="w-[300px] h-[400px] rounded-lg shadow-lg overflow-hidden bg-white animate-pulse">
...
const EmptyCourses = () => (
  <div className="flex flex-col items-center justify-center py-16 gap-4 text-center">
    ...
    <h3 className="text-xl font-semibold text-gray-500">Hozircha kurslar mavjud emas</h3>
    <p className="text-gray-400 max-w-sm">Bu ustoz hali kurs qo'shmagan. Keyinroq tekshiring.</p>
  </div>
);
                  ...
                  <div className="p-5 flex-1 flex flex-col bg-white">
                    ...
                    <div className="flex justify-between mt-auto text-gray-500 text-sm">
                      <span className="flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#098CE9" width="16px" height="16px" viewBox="0 0 256 256">
                        ...
                        <p><span>{value?.buyers_total}</span> O'quvchilar</p>
                      </span>
                      <span className="flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 16 17" fill="none">
                          <path d="M9.33317 1.83331H3.99984C3.64622 1.83331 3.30708 1.97379 3.05703 2.22384C2.80698 2.47389 2.6665 2.81302 2.6665 3.16665V13.8333C2.6665 14.1869 2.80698 14.5261 3.05703 14.7761C3.30708 15.0262 3.64622 15.1666 3.99984 15.1666H11.9998C12.3535 15.1666 12.6926 15.0262 12.9426 14.7761C13.1927 14.5261 13.3332 14.1869 13.3332 13.8333V5.83331L9.33317 1.83331Z" stroke="#098CE9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                          <path d="M9.3335 1.83331V5.83331H13.3335" stroke="#098CE9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                          <path d="M10.6668 9.16669H5.3335" stroke="#098CE9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                          <path d="M10.6668 11.8333H5.3335" stroke="#098CE9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                          <path d="M6.66683 6.5H6.00016H5.3335" stroke="#098CE9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                        <p><span>{value?.topics_count}</span> Darsliklar</p>
                      </span>
                    </div>
                  </div>
                </div>
                  ...
                  {activeCard === value?.id && (
                    ...
                    >
                      <div className="mb-4 p-2 bg-blue-50 rounded-md">
                        <h3 className="text-lg font-bold text-center">{value?.title}</h3>
                      </div>
                      <div className="flex-1 overflow-y-auto">
                        <p className="text-gray-700 mb-4">
                          {truncateDescription(value?.about)}
                        </p>
