...
import { Briefcase, Calendar, GraduationCap, MapPin, Users } from "lucide-react"; // Ikonkalar uchun lucide-react ishlating
  ...
  return (
    <>
      ...
      <section className="mt-16">
        <h3 className="text-2xl font-bold mb-8 text-center flex items-center">
          <span className=''>
              ...
              >
                ...
                <div className="p-4 flex flex-col flex-1 gap-2">
                  <div className="flex items-center gap-1 text-gray-400 text-[12px]">
                    <svg className="text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="#3b82f6" width="16px" height="16px" viewBox="0 0 256 256">
                  ...
                  <div className="mt-2">
                    {value?.price === 0 || value?.price === "0" || !value?.price ? (
                      <span className="text-[16px] font-bold text-blue-500">Bepul</span>
                    ) : (
