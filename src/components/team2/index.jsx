...
const SkeletonProfile = () => (
  <div className="w-[90%] max-w-6xl m-auto p-8 bg-white rounded-3xl shadow-xl mt-[60px] animate-pulse">
...
export default function Team2() {
  ...
  return (
    <>
      ...
      <div className="relative bg-white rounded-[32px] p-8 md:p-12 shadow-2xl shadow-blue-100/50 border border-blue-50 overflow-hidden">
        ...
        <div className="relative flex flex-col md:flex-row items-center md:items-start gap-10">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="mt-8">
              <h3 className="text-sm uppercase tracking-widest text-gray-400 font-bold mb-3">Mentor haqida</h3>
              <p className="text-gray-600 leading-relaxed text-lg max-w-3xl italic">
                "{profile.about}"
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-10">
              <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                <div className="p-3 bg-white rounded-xl shadow-sm"><Briefcase size={20} className="text-blue-500" /></div>
                <div>
                  <p className="text-xs text-gray-400 font-bold uppercase">Ish joyi</p>
                  <p className="text-gray-700 font-semibold">{profile.work_place}</p>
                </div>
              </div>
              <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                <div className="p-3 bg-white rounded-xl shadow-sm"><Users size={20} className="text-blue-500" /></div>
                <div>
                  <p className="text-xs text-gray-400 font-bold uppercase">O'quvchilar</p>
                  <p className="text-gray-700 font-semibold">{courseTeacher.reduce((a, b) => a + (b.buyers_total || 0), 0)} ta</p>
                </div>
              </div>
              <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                <div className="p-3 bg-white rounded-xl shadow-sm"><GraduationCap size={20} className="text-blue-500" /></div>
                <div>
                  <p className="text-xs text-gray-400 font-bold uppercase">Kurslar soni</p>
                  <p className="text-gray-700 font-semibold">{courseTeacher.length} ta</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6 justify-items-center md:justify-items-start">
            {courseTeacher.map((value, index) => (
              <motion.div
                ...
                className="w-full bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-md hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer flex flex-col group"
              >
                ...
                <div className="p-4 flex flex-col flex-1 gap-2 bg-white">
                  ...
                  <div className="flex items-center gap-1 text-gray-400 text-[12px]">
                    ...
                    <span className="font-medium text-gray-700">{value?.buyers_total}</span>
                    <span className="text-gray-400">o'quvchi</span>
                  </div>

                  <h3 className="text-[15px] md:text-[16px] font-bold text-gray-900 leading-snug line-clamp-2 group-hover:text-blue-600 transition-colors">
                    {value?.title}
                  </h3>

                  <p className="text-[12px] md:text-[13px] text-gray-500 leading-relaxed line-clamp-3 flex-1">
