...
function EmptySections({ courseTitle }) {
  return (
    <div className="flex flex-col items-center justify-center py-10 px-4 text-center gap-4">
      ...
      <div>
        <p className="text-gray-700 font-semibold text-sm">Darslar hali qo'shilmagan</p>
...
const FrontendCourse = () => {
  ...
  // Access yuklanayotgan bo'lsa yoki sotilmagan bo'lsa — loading ko'rsat
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="w-full lg:w-1/4 bg-white p-4 rounded-lg shadow">
            {sectionsLoading ? (
              ...
              <EmptySections courseTitle={courseData?.title} />
            ) : (
              <div className="space-y-2">
                ...
                <div className="flex flex-col items-center justify-center py-16 gap-4 text-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm mt-2 max-w-sm leading-relaxed">
                      Hozircha bu kursda darslar mavjud emas. O'qituvchi tez orada video darslar va topshiriqlarni qo'shadi.
                    </p>
                  </div>
                  <div className="flex flex-col gap-2 w-full max-w-xs">
                    <div className="flex items-center gap-3 bg-gray-50 rounded-xl px-4 py-3">
                      ...
                      <div className="text-left">
                        <p className="text-xs font-medium text-gray-600">Video darslar</p>
                    ...
                    <div className="flex items-center gap-3 bg-gray-50 rounded-xl px-4 py-3">
                      <span className="text-lg">💻</span>
                      <div className="text-left">
                        <p className="text-xs font-medium text-gray-600">Amaliy topshiriqlar</p>
                        <p className="text-xs text-gray-400">Tez orada qo'shiladi</p>
                      </div>
                    </div>
                  </div>
