...
function SkeletonCard() {
  return (
    <div className="w-[300px] h-[400px] rounded-lg shadow-lg overflow-hidden bg-white">
...
function KirishComponents() {
  ...
  const { data, setData, fetchCourse } = useData();
                  ...
                  <div className="p-5 flex-1 flex flex-col bg-white">
                    ...
                    <div className="flex justify-between mt-auto text-gray-500 text-sm">
                      <span className="flex items-center gap-2">
                        ...
                        <p>
                          <span>{value?.buyers_total}</span> O'quvchilar
                        </p>
                      </span>
                      ...
                      <span className="flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 16 17" fill="none">
                          ...
                          <path d="M9.3335 1.83331V5.83331H13.3335" stroke="#098CE9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                          <path d="M10.6668 9.16669H5.3335" stroke="#098CE9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                          <path d="M10.6668 11.8333H5.3335" stroke="#098CE9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                          <path d="M6.66683 6.5H6.00016H5.3335" stroke="#098CE9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                        </svg>
                        <p>
                          <span>{value?.topics_count}</span> Darsliklar
                        </p>
                      </span>
                    </div>
                  </div>
