      ...
      <div className="relative rounded-3xl flex flex-col w-full max-w-3xl gap-2">
        ...
        <div className="flex flex-col gap-5 px-4 sm:px-7 py-6">
            ...
            >
              {banner ? (
                <>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center rounded-2xl opacity-0 hover:opacity-100 transition-opacity" style={{ background: "rgba(0,0,0,0.45)" }}>
          ...
          <div className="flex items-center justify-end gap-3 pt-2">
            ...
            <button onClick={handleSubmit} disabled={load} className="px-6 py-2.5 flex items-center gap-2 bg-blue-500 text-gray-100 rounded-md text-sm font-semibold transition-all">
