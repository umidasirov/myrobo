          ...
          {data?.length > 0 ? (
            data.map((value) => (
              <div
                ...
                className="w-[280px] bg-white dark:bg-gray-800 rounded-2xl overflow-hidden border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-200 cursor-pointer flex flex-col"
              >
                <div className="h-[180px] overflow-hidden flex-shrink-0 bg-gray-100 dark:bg-gray-700">
                  <img
