...
function SertificateComponents() {
  ...
  return (
    <motion.section
      className="bg-[#f1f2f7] rounded-md py-6 sm:py-8 md:py-[30px] mt-5 md:mt-[20px]"
      initial="hidden"
      whileInView="visible"
      viewport={{ once: true, margin: "-100px" }}
      variants={containerVariants}
    >
      <div className="w-full md:w-[90%] m-auto px-4 md:px-0">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 rounded-md gap-4 sm:gap-6 md:gap-[30px]">
          <motion.div
          ...
          >
            ...
            <div className="w-[80%] flex flex-col gap-2">
              ...
              <p className="text-gray-500 md:text-[17px] max-[768px]:text-[14px]">
          ...
          >
            ...
            <div className="w-[80%] flex flex-col gap-2">
              ...
              <p className="text-gray-500 text-[5px] md:text-[17px] max-[768px]:text-[14px]">
